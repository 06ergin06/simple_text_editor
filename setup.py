...
APP_NAME = "hakkitor"
APP_ID = "me.ihakkiergin.hakkitor"
...
setup(
    ...
    author_email="ibrahimh.ergin@gmail.com",
    description="Hakki text editor is a simple text editor.",
    license="GPLv3",
    keywords="text editor",
    url="https://github.com/06ergin06/simple_text_editor",
)
